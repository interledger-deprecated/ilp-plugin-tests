'use strict'
/*
 * This is an example test config using ilp-plugin-bells.
 * It requires two live five-bells-ledger accounts. Account
 * 1 should be funded substantially (50-100 units of currency),
 * especially if you want to run these tests several times.
 */
